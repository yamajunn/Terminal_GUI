...
# 画像のファイルパスを指定
image_path = "/Users/chinq500/Desktop/GUI/image2.jpeg"
...
chars_list = [('M', 0.037*27), ('@', 0.037*26), ('%', 0.037*25), ('N', 0.037*24), ('B', 0.037*23), ('w', 0.037*22), ('m', 0.037*21), ('6', 0.037*20), ('E', 0.037*19), ('b', 0.037*18), ('4', 0.037*17), ('3', 0.037*16), ('2', 0.037*15),
              ('k', 0.037*14), ('7', 0.037*13), ('f', 0.037*12), ('1', 0.037*11), ('l', 0.037*10), ('r', 0.037*9), ('i', 0.037*8), ('!', 0.037*7), ('/', 0.037*6), ("'", 0.037*5), ('-', 0.037*4), (',', 0.037*3), ('_', 0.037*2), (' ', 0.037*1)]
